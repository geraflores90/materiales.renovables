% Grafica la energia solar recibida en un año a una latitud especifica.
...
graf2=horzcat(mat_dias,matE);
plot(graf2(:,1),graf2(:,2),'o','markersize',4)
title('E anual a latitud =19°')
xlabel('Día')
ylabel('E')
